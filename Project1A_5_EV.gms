...
Parameter
    ...
    P(t) average price /1 45, 2 55, 3 96.67, 4 83.33, 5 110, 6 115, 7 96.67, 8 60, 9 95/
...
Parameter
    P1(t) /1 45, 2 55, 3 80, 4 80, 5 110, 6 110, 7 80, 8 30, 9 70/
    P2(t) /1 45, 2 55, 3 95, 4 80, 5 80, 6 130, 7 130, 8 60, 9 95/
    P3(t) /1 45, 2 55, 3 120, 4 90, 5 140, 6 105, 7 80, 8 90, 9 120/;

EEV = sum((i,t), 3600*eta(i)*P1(t)*V.l(i,t))/3 + sum((i,t), 3600*eta(i)*P2(t)*V.l(i,t))/3 + sum((i,t), 3600*eta(i)*P3(t)*V.l(i,t))/3;
